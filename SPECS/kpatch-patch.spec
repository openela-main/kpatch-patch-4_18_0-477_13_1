...
%define kernel_ver	4.18.0-477.13.1.el8_8
...
#
# https://bugzilla.redhat.com/2213244
Source100: CVE-2022-42896.patch
#
# https://bugzilla.redhat.com/2184149
Source101: CVE-2023-1281.patch
#
# https://bugzilla.redhat.com/2192504
Source102: CVE-2023-1829.patch
#
# https://bugzilla.redhat.com/2219677
Source103: CVE-2023-3090.patch
#
# https://bugzilla.redhat.com/2216179
Source104: CVE-2023-3390-2.patch
#
# https://bugzilla.redhat.com/2221752
Source105: CVE-2023-35001.patch
#
# https://bugzilla.redhat.com/2217008
Source106: CVE-2023-35788.patch
#
# https://bugzilla.redhat.com/2225664
Source107: CVE-2023-3776.patch
#
# https://bugzilla.redhat.com/2228798
Source108: CVE-2023-4004.patch
...
%changelog
* Mon Sep 11 2023 Yannick Cote <ycote@redhat.com> [1-2.el8_8]
...
* Tue Jul 25 2023 Yannick Cote <ycote@redhat.com> [1-1.el8_8]
- kernel: Use-after-free vulnerability in the Linux Kernel traffic control index filter [2192504] {CVE-2023-1829}
- kernel: tcindex: use-after-free vulnerability in traffic control index filter allows privilege escalation [2184149] {CVE-2023-1281}
- kernel: use-after-free in l2cap_connect and l2cap_le_connect_req in net/bluetooth/l2cap_core.c [2213244] {CVE-2022-42896}

* Tue May 23 2023 Yannick Cote <ycote@redhat.com> [0-0.el8]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-477.13.1.el8_8 [2209331]
